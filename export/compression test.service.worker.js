...
/** @type {string} */
const CACHE_VERSION = '1743847936|89257414';
/** @type {string} */
const CACHE_PREFIX = 'compression test-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'compression test.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["compression test.html","compression test.js","compression test.offline.html","compression test.icon.png","compression test.apple-touch-icon.png","compression test.audio.worklet.js","compression test.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["compression test.wasm","compression test.pck"];
